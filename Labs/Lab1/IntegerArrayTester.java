...
final class IntegerArray{
    ...
    {
        this.ia = Arrays.copyOf(a, a.length);
    }
    ...
    public IntegerArray getSorted(){
        int[] ias = Arrays.copyOf(ia, ia.length);
        Arrays.sort(ias);
    ...
    {
        int[] iac = new int[this.length()+ ia.length()];
        ...
        for(int i = this.length(); i<iac.length; i++)
        {
            iac[i] = ia.getElementAt(i-this.length());
        }

        IntegerArray concatenated = new IntegerArray(iac);
        return concatenated;
    }
    ...
    public String toString() {
        ...
        sb.append(ia[this.length()-1]).append("]");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(ia, that.ia);
    }
