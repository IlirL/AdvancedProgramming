...
public class LocalDateTest {
    ...
    static LocalDate create() {
         ...
         */
        LocalDate ld = LocalDate.of(2015, Month.JUNE, 18);
        return ld;
    }
    ...
    static LocalDate parse() {
         ...
         */
        LocalDate ld = LocalDate.parse("2015-06-18", DateTimeFormatter.ISO_LOCAL_DATE);
        return ld;
    }
    ...
    static LocalDate withAdjuster() {
         ...
         */
        LocalDate lD= ld.with(TemporalAdjusters.firstDayOfNextYear());
        return lD;
    }
